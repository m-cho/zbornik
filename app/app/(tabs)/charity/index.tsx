...
export default function CharityScreen() {
  ...
  const items = [{
    ...
    type: 'church',
    title: i18n.t('charity.items.freskopisanjeCrkvaSvCaraKonstantinaICariceJelene.title'),
    description: i18n.t('charity.items.freskopisanjeCrkvaSvCaraKonstantinaICariceJelene.description'),
