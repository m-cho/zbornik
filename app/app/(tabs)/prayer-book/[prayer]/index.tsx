import prayersMetadata from "@/assets/prayer-book/sr-Cyrl/prayers-metadata.json";
...
export function generateStaticParams(): { prayer: string }[] {
  return prayersMetadata.map((p) => ({ prayer: p.id }));
}
