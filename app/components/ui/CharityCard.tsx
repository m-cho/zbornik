...
export default function CharityCard({
  ...
  return (
    ...
    >
      <ThemedView
        style={[styles.body, { backgroundColor: cardBackgroundColor }]}
      >
        ...
        <ThemedText
          style={[styles.description, isLargeScreen && styles.descriptionLarge]}
          numberOfLines={3}
        >
          {description}
        </ThemedText>
        ...
        >
          {onPressAbout ? (
            <TouchableOpacity
              ...
              style={[styles.aboutAction, { borderColor: textColor }]}
